...
from worldgen import CONTROL, MAP_OUT, WorldModel, build_model, coastal_edges
...
def template_text(model: WorldModel) -> str:
    ...
    lines = [
        ...
        "# M2 terrain plus engine-required placeholders; M4/M5 replace people/faith/goods.",
    ]
