...
- v117's fresh live session proves the player visual profile renders physical close terrain
  and completes 45 seconds of playback, but its Finder text injection hit the native UI's
